...
public interface ItemMapper {
    ...
    @Insert("insert into item (suit,image,deposit,delivery_style,address,usage_level,original_price,sell_price,owneruid,status,trade_mode,tag,item_desc,item_title,create_time, update_time) " +
            "values (#{suit},#{image},#{deposit},#{deliveryStyle},#{address},#{usageLevel},#{originalPrice},#{sellPrice},#{ownerUid},#{status},#{tradeMode},#{tag},#{itemDesc},#{itemTitle},#{createTime},#{updateTime})")
