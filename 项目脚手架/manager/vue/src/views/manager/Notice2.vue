<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入标题查询" style="width: 200px" v-model="content"></el-input>
      ...
      <el-table :data="tableData" stripe @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="content" label="通知内容" align="center">
          <template slot-scope="{ row }">
            <div class="truncate-text">{{ row.content }}</div>
          </template>
        </el-table-column>
    ...
    <!-- 修改内容dialog -->
    <el-dialog title="修改通知" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form"  ref="formRef">

        <el-form-item prop="content" label="通知内容">
          <el-input v-model="form.content" placeholder="物品标题"></el-input>
        </el-form-item>
