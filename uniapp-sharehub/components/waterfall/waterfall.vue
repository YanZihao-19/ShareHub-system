<template name="waterfall">
	<view class="waterfall">
		...
		<view>
						...
						<view v-for="(item, index) in list1" :key="item.id" class="waterfall-item"
							...
							<view class="waterfall-item__ft">
								...
								<view class="waterfall-item__ft__btn" v-if="index==0">
									<button type="primary" style="height: 60rpx;line-height: 60rpx;font-size: 28rpx;"
			...
			<!-- #ifdef APP-NVUE -->
			<uv-waterfall column-count="2" left-gap="10" right-gap="10" column-gap="8" :height="waterfallHeight"
				@scrolltolower="init">
