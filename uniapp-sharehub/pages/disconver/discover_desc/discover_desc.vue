		...
		<view class='pg'>
			...
			<view class='user-top  padding-sm bg-white '>
				...
				<view class='user-top-3'>
					<button bindtap='attention' class="cu-btn round line-black" role="button"
						aria-disabled="false">+关注</button>
				</view>
			</view>
			...
			<view class='browse shadow-warp  padding-sm bg-white'>
				<view class="cu-avatar-group">
					<view class="cu-avatar img-size round lg" v-for="(item,index) in 3" :key="item"
			...
			<view class='padding shadow-warp  bg-white comment-content' v-for="(item,index) in discuss" :key="index">
				<view class='comment-content-1'>
					...
					<view>
						<text class='cuIcon-appreciate lg text-gray'></text>{{item.cook}}
					</view>
				</view>
			...
			<!-- #ifndef APP-PLUS  -->
			<!-- 热门评论内容 -->
			<view class='padding shadow-warp  bg-white comment-content' v-for="(item,index) in discuss"
				:key=" 'idA' + index">
				<view class='comment-content-1'>
					<view class='comment-content-1_image'>
						<image :src='item.image'></image>
