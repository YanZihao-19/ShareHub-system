		...
		<view class='container'>
			<view class='classify'>
				...
				<scroll-view scroll-y>
					<view class="classify-classify  " :class=" index == sss ? 'select  text-green ' : '' "
						v-for="(item,index) in classinfy" :key="index" @tap='showClassify' :data-title='item.title'
						:data-id='index'><text>{{item.title}}</text></view>
				</scroll-view>
			</view>

			<!-- rigth -->
			<view class='rigth animation-reverse  ' :class=" 'animation-' + animation">
				<view class='rigth-image'>
