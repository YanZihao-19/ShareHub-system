	...
	<view>
		...
		<view class='containers bg-white padding-sm'>
			...
			<view class='container-1'>
				...
				<view class='container-1_1'>
					<image
						src='https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1560330807954&di=bbac5a091acb632c9c0716d478f1a75f&imgtype=0&src=http%3A%2F%2Fimg.pconline.com.cn%2Fimages%2Fupload%2Fupc%2Ftx%2Fwallpaper%2F1209%2F26%2Fc0%2F14139494_1348624365103.jpg'>
					</image>
				</view>
		...
		<view id="navTab" class="bg-white margin-top  nav_list ">
			<view :data-id='index' class="nav_item " :class="index==TabCur ? 'cur' : '' "
				v-for="(item,index) in TabList" :key="index" @tap='tabSelect'>
				<text>{{TabList[index]}}</text>
				<image :src="'../../../static/img/' + [imgState? 'top' : 'boutton'] + '.png' " v-if="index == 2">
				</image>
			</view>
