	...
	<view>
		...
		<view class='pg'>
			<view class='container bg-white'>
				...
				<view class='container-top_rigth'>
					<view class='container-top_rigth_1'><text>【转卖】厨房下水道管道疏通剂方
							【转卖】厨房下水道管道疏通剂方厨房下水道管道疏通剂方厨房下水道管道疏通剂方厨房下水道管道疏通剂方</text></view>
					<view class='container-top_rigth_2'>
						<view class='container-top_rigth_2_1'><text class='text-price text-red text-xl'>12.88</text>
						</view>
		...
		<view class='foot bg-white'>
			<view class='foot-1'><text class='foot-1_1'>实付款:</text><text
					class='text-price text-red foot-1_2'>12.88</text></view>
